        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    UrlName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ListCategories = table.Column<bool>(type: "bit", nullable: false),
                    ListProjects = table.Column<bool>(type: "bit", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressGoogleMaps = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DoneProjectsCount = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DoneCustomerCount = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Text1 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Text2 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Text3 = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PageCarousels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PageCarousels_PageContents_PageContentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_UrlName",
                table: "Categories",
                column: "UrlName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PageCarousels_PageContentId",
                table: "PageCarousels",
